...
//     }
    ...
    kernelKmeansShmem(output_vals, input_vals, centroids, opts.num_cluster, n_vals, opts.dims, opts.max_num_iter, opts.threshold);
...
//             for (int d = 0; d<opts.dims; d++){
//                 if (d < opts.dims -1){
//                     std::cout << input_vals[i*opts.dims + d] <<" ";
//                 }
//                 else{
//                     std::cout << input_vals[i*opts.dims + d];
//                 }
